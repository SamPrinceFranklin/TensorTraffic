...
"[project]/src/lib/incidents.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/incidents.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function MapComponent({ showWaterLogging, showAccidents, showPowerCuts, center = defaultCenter, zoom = 12, containerStyle = defaultContainerStyle }) {
    ...
    const incidentsToDisplay = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["incidents"].filter((incident)=>{
...
"[project]/src/ai/flows/data:2db279 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$2db279__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:2db279 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/incidents.ts [app-ssr] (ecmascript)");
...
function MapPage() {
    ...
    const [showAccidents, setShowAccidents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showPowerCuts, setShowPowerCuts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const getFilteredIncidents = ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["incidents"].filter((incident)=>{
            if (showWaterLogging && incident.category === 'Water Logging') return true;
            if (showAccidents && incident.category === 'Accident') return true;
            if (showPowerCuts && incident.category === 'PowerCut') return true;
            return false;
    ...
    const handleSummarize = async ()=>{
        ...
        setSummary(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$2db279__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["summarizeIncidents"])({
...
//# sourceMappingURL=src_159b012a._.js.map