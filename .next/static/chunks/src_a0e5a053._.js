...
"[project]/src/lib/incidents.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const incidents = [
    {
        ...
        severity: 'Medium',
        description: 'Major intersection flooded, causing traffic delays.',
    ...
    },
    {
        ...
        category: 'Accident',
        severity: 'High',
        description: 'Two-car collision with injuries reported. Emergency services on scene.',
    ...
    },
    {
        ...
        category: 'Water Logging',
        severity: 'Low',
        description: 'Minor flooding on a residential street.',
        timestamp: new Date('2024-07-21T09:15:00Z')
    },
    {
        id: 4,
        lat: 37.79,
        ...
        timestamp: new Date('2024-07-21T18:45:00Z')
    },
    {
        id: 5,
        lat: 37.75,
        ...
        category: 'Water Logging',
        severity: 'High',
        description: 'Underpass completely submerged. Road closed.',
    ...
    },
    {
        ...
        category: 'Accident',
        severity: 'Medium',
        description: 'Minor fender-bender, no injuries reported but causing traffic slowdown.',
        timestamp: new Date('2024-07-21T16:20:00Z')
    },
    {
        id: 7,
        lat: 37.785,
        ...
        category: 'PowerCut',
        severity: 'Medium',
        description: 'Power flickering in the downtown area. Crews are investigating.',
        timestamp: new Date('2024-07-21T20:05:00Z')
    },
    {
        id: 8,
        lat: 37.765,
        ...
        category: 'Accident',
        severity: 'Low',
        description: 'A cyclist and a pedestrian collided. Minor injuries.',
        timestamp: new Date('2024-07-21T13:10:00Z')
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/incidents.ts [app-client] (ecmascript)");
;
...
function MapComponent({ showWaterLogging, showAccidents, showPowerCuts, center = defaultCenter, zoom = 12, containerStyle = defaultContainerStyle }) {
    _s();
    ...
    const incidentsToDisplay = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["incidents"].filter((incident)=>{
...
function MapPage() {
    ...
    const [showAccidents, setShowAccidents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showPowerCuts, setShowPowerCuts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const getFilteredIncidents = ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$incidents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["incidents"].filter((incident)=>{
            if (showWaterLogging && incident.category === 'Water Logging') return true;
            if (showAccidents && incident.category === 'Accident') return true;
            if (showPowerCuts && incident.category === 'PowerCut') return true;
            return false;
...
_s(MapPage, "1drKzphy5zk6NQerqds+H4rH+D8=", false, function() {
    return [
...
//# sourceMappingURL=src_a0e5a053._.js.map